...
struct line_mgmt {
    ...
    // pqueue_t *invalid_line_pq; 
    // pqueue_t *victim_line_stream;
    QTAILQ_HEAD(, line) *victim_line_stream; 
    //QTAILQ_HEAD(victim_line_list, line) victim_line_list;
    QTAILQ_HEAD(, line) *full_line_stream; 
